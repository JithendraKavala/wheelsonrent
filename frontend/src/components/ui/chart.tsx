...
type ChartContainerProps = React.HTMLAttributes<HTMLDivElement> & {
  ...
  id?: string
  children:
    | ((props: { width: number; height: number }) => React.ReactElement) // function as child
    | React.ReactElement // or plain React element
}
  ...
  ({ id, className, children, config, ...props }, ref) => {
    ...
    const ChartContent = () => {
      if (typeof children === "function") {
        const Wrapper = () => children({ width: 0, height: 0 })
        return (
      ...
      return (
        <RechartsPrimitive.ResponsiveContainer>
          {React.cloneElement(children as React.ReactElement, { width: 0, height: 0 })}
        </RechartsPrimitive.ResponsiveContainer>
      )
    }
